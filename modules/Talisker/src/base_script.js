...
const TASKS = [
    ...
    },
    {
        ...
        "fillNullValue": 0,
        "invertResult": false,
        "query": "SELECT average(apm.service.transaction.duration) * 1000 AS ReturnValue FROM Metric WHERE appName ='sock-shop-frontend' AND transactionType = 'Web' SINCE 1 hours AGO compare with 1 day ago"
    },
]
                ...
                try {
                    ...
                    if (bodyJSON.data.actor.account.nrql.results.length == 2 && bodyJSON.data.actor.account.nrql.results[0].comparison && bodyJSON.data.actor.account.nrql.results[0].comparison) {
                        ...
                        result = bodyJSON.data.actor.account.nrql.results.map((result) => {
                            ...
                            let resultValue = result[task.selector]
                        ...
                        result = resultData[task.selector]
                    }
